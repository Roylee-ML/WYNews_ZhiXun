...
#define NAVIGATION_BAR_HEIGHT           self.parentViewController.navigationController.navigationBar.frame.size.height
#define TAB_TAB_HEIGHT                  self.parentViewController.tabBarController.tabBar.frame.size.height
...
#define ARROW_BUTTON_WIDTH              SCREEN_WIDTH/50
#define NAV_TAB_BAR_HEIGHT              ARROW_BUTTON_WIDTH
#define ITEM_HEIGHT                     SCREEN_WIDTH/20
