...
- (NSString *)formattedDateDescription
{
    ...
    if (timeInterval < 60) {
        ...
        return [NSString stringWithFormat:NSLocalizedString(@"NSDateCategory.text3", @""), timeInterval / 3600.0];
...
/*精确到秒的时间描述，用于视频播放*/
+ (NSString *)formattedPlayTimeFromTimeInterval:(NSTimeInterval)time
{
    NSDateFormatter * dateFormater = [NSDateFormatter dateFormatterWithFormat:@"HH:mm:ss"];
...
+ (NSString *)formattedTimeStandardFromTimeInterval:(long long)time{
