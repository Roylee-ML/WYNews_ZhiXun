...
#import "NSObject+Extesion.h"
#import <AudioToolbox/AudioToolbox.h>

@implementation NSObject (Extesion)
...
-(void)heartAnimation:(UIButton *)sender
{
    ...
    kAnimation.values =  @[@(1.0),@(0.8),@(0.6),@(0.8),@(1.0),@(1.2),@(1.1)];
    kAnimation.keyTimes = @[@(0.0),@(0.08),@(0.2),@(0.3),@(0.45),@(0.75),@(0.9),@(1.0)];
    kAnimation.calculationMode = kCAAnimationLinear;
    [sender.layer addAnimation:kAnimation forKey:@"SHOW"];
}
