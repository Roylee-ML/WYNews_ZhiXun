...
//下拉刷新
-(void)loadData{
    NSString *url =@"http://c.m.163.com/nc/article/list/T1348648141035/0-20.html";
...
-(void)refreshFooterView{
    ...
    NSString *url=[NSString stringWithFormat:@"http://c.m.163.com/nc/article/list/T1348648141035/%@.html",pageCount ];
